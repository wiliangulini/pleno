  ...
  <footer>
    <div class='container-fluid'>
      <div class='row'>
        ...
        <div class='col-sm-3 col-md-3 col-lg-3 one'>
          <p class='h5'>Sou psicologo</p>
          <p class='txt'><a href='conhecer.php'>Conhecer mais</a></p>
          <p class='txt'><a href=''>Cadastrar</a></p>
          <p class='txt'><a href=''>Benefícios</a></p>
        </div>
        <div class='col-sm-3 col-md-3 col-lg-3 two'>
        ...
        <div class='col-sm-3 col-md-3 col-lg-3 three'> 
          <p class='h5'>Dúvidas</p>
          <p class='txt'><a href=''>Fale conosco</a></p>
          <p class='txt'><a href='politica-de-privacidade.php'>Politica de privacidade</a></p>
          <p class='txt'><a href='perguntas-frequentes.php'>Perguntas frequentes</a></p>
        </div>
      </div>
    </div>
  </footer>